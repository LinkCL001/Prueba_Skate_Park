...
const ingresar = (x) => pool.query('INSERT INTO skaters(email,nombre,password,anos_experiencia,especialidad,foto) VALUES($1,$2,$3,$4,$5)', [x.email, x.nombre, x.password, x.anos_experiencia,x.especialidad, x.foto])
